...
namespace NeoFPS
{
    public abstract class BaseSprintAnimationHandler : MonoBehaviour
    {
        ...
        protected bool sprintBlocked
        {
            get { return m_SprintBlockers > 0; }
        }
        ...
        protected virtual void FixedUpdate()
        {
            ...
            if (m_CharacterController != null)
            {
                //sprintSpeed = m_CharacterController.velocity.magnitude;
                sprintSpeed = Mathf.Lerp(sprintSpeed, m_CharacterController.velocity.magnitude, 0.1f);
            }
        }
        ...
        protected void AddSprintBlocker()
        {
            ...
            {
                Debug.Log("Setting canSprint to false");
