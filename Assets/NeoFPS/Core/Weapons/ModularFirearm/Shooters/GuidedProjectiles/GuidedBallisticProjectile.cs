    ...
    public class GuidedBallisticProjectile : MonoBehaviour, IProjectile, INeoSerializableComponent, IOriginShiftSubscriber
    {
        ...
        protected void FixedUpdate ()
		{
			...
			else
			{
                ...
                if (PhysicsExtensions.RaycastNonAllocSingle (ray, out m_Hit, distance, m_Layers, m_IgnoreRoot, queryTriggers))
				{
                    ...
                    m_AmmoEffect.Hit (m_Hit, transform.forward, m_Distance, velocity.magnitude, m_DamageSource);
		...
		void Update ()
        {
            if (m_Rigidbody == null)
            {
                ...
                transform.position = Vector3.Lerp(m_LerpFromPosition, m_LerpToPosition, lerp);
            }
		}
