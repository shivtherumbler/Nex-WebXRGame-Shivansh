...
namespace NeoFPS
{
    public abstract class LockpickPopup : MonoBehaviour
    {
        ...
        public static bool ShowLockpickPopup(string id, float difficulty, ICharacter character, IInventoryItem pickItem, UnityAction<ICharacter> onUnlock, UnityAction onCancel)
        {
            LockpickPopup known;
