...
namespace NeoFPS
{
    ...
    public class FpsGamepadSettings : SettingsContext<FpsGamepadSettings>
    {
        ...
        {
            m_AnalogSensitivityH = Mathf.Clamp(m_AnalogSensitivityH, k_MinSensitivity, k_MaxSensitivity);
            m_AnalogSensitivityV = Mathf.Clamp(m_AnalogSensitivityV, k_MinSensitivity, k_MaxSensitivity);
        }
        ...
        public override void OnLoad()
        {
            ...
            m_ProfileIndex = Mathf.Clamp(m_ProfileIndex, 0, NeoFpsInputManagerBase.numGamepadProfiles);
        }
#endif
        ...
        {
#if NEOFPS_LOAD_ON_DEMAND
            get { return Mathf.Clamp(m_ProfileIndex, 0, NeoFpsInputManagerBase.numGamepadProfiles); }
#else
            get { return m_ProfileIndex; }
#endif
            set
            {
                SetValue(ref m_ProfileIndex, Mathf.Clamp(value, 0, NeoFpsInputManagerBase.numGamepadProfiles));
                if (onSettingsChanged != null)
                    onSettingsChanged();
            }
        }
        ...
        public float horizontalAnalogSensitivity
        {
            ...
            set
            {
                SetValue(ref m_AnalogSensitivityH, Mathf.Clamp(value, k_MinSensitivity, k_MaxSensitivity));
                if (onSettingsChanged != null)
                    onSettingsChanged();
            }
        }
        ...
        public float verticalAnalogSensitivity
        {
            ...
            set
            {
                SetValue(ref m_AnalogSensitivityV, Mathf.Clamp(value, k_MinSensitivity, k_MaxSensitivity));
                if (onSettingsChanged != null)
                    onSettingsChanged();
            }
        }
        ...
        public int profile
        {
            get { return Mathf.Clamp (GetInt ("gpad.profile", m_ProfileIndex), 0, NeoFpsInputManagerBase.numGamepadProfiles); }
			set
            {
        ...
        public float horizontalAnalogSensitivity
        {
            ...
            set
            {
                SetFloat("gpad.analogSensitivityH", Mathf.Clamp(value, k_MinSensitivity, k_MaxSensitivity));
                if (onSettingsChanged != null)
                    onSettingsChanged();
            }
        }
        ...
        public float verticalAnalogSensitivity
        {
            ...
            set
            {
                SetFloat("gpad.analogSensitivityV", Mathf.Clamp(value, k_MinSensitivity, k_MaxSensitivity));
                if (onSettingsChanged != null)
                    onSettingsChanged();
            }
        }
