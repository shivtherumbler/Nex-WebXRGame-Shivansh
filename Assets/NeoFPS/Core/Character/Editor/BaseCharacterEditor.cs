    ...
    public class BaseCharacterEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            if (damageProp.boolValue)
            {
                ...
                EditorGUILayout.PropertyField(serializedObject.FindProperty("m_FallDamageHandler"));
            }
            ...
            if (damageProp.boolValue)
            {
                ...
                EditorGUILayout.PropertyField(serializedObject.FindProperty("m_BodyDamageHandler"));
            }
            ...
            if (damageProp.boolValue)
            {
                ...
                EditorGUILayout.PropertyField(serializedObject.FindProperty("m_HeadDamageHandler"));
            }
